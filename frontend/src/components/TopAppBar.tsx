...
export function TopAppBar() {
  return (
    <header className="flex items-center justify-between border-b border-card-border bg-surface px-4 py-3">
      ...
      <button className="flex h-8 w-8 items-center justify-center rounded hover:bg-surface-container focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-primary focus-visible:ring-offset-2" aria-label="设置" title="设置">
